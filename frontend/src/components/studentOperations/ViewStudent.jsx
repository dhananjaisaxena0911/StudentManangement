          ...
          <table className="min-w-full bg-white border border-gray-300">
            <thead>
              <tr className="bg-gray-100">
                <th className="py-2 py-4 border">Roll No</th>
                <th className="py-2 py-4 border">Name</th>
                <th className="py-2 py-4 border">Class</th>
                <th className="py-2 py-4 border">Age</th>
                <th className="py-2 py-4 border">Course</th>
              </tr>
            </thead>
            <tbody>
