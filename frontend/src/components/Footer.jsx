...
function Footer() {
  return (
    <div className=" flex w-[100vw] h-[25vh] justify-center items-center gap-11 bg-black absolute bottom-0">
      ...
      <div className="w-[23%] flex flex-col gap-3">
        <div className="text-white">Gurugram</div>
        <div className="">
          <p className="text-white">+54 1167997949</p>
          <p className="text-white">
            10th floor, Tower-B, UNITECH CYBER PARK, Durga Colony, Sector 39,
        ...
        <div className="">
          <p className="text-white hover:text-blue-500">
            {" "}
            <a href="https://www.google.com/maps/dir//10th+floor,+Tower-B,+UNITECH+CYBER+PARK,+Durga+Colony,+Sector+39,+Gurugram,+Haryana+122001/@28.4438322,76.9743148,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x390d18ec8956b191:0xccefb28ce65311fc!2m2!1d77.0567162!2d28.443857?entry=ttu&g_ep=EgoyMDI1MDQwOC4wIKXMDSoJLDEwMjExNDUzSAFQAw%3D%3D">
              See On Map{" "}
            </a>{" "}
          </p>
        </div>
